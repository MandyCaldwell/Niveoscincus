...
longlat<-c(146.5666667,-41.85) #central plateau c(146.5666667,-41.85) Orford c(147.829971,-42.557127) 
...
dstart<-as.POSIXct(as.Date('01/01/2009', "%d/%m/%Y"))-3600*11
dfinish<-as.POSIXct(as.Date('31/12/2010', "%d/%m/%Y"))-3600*10
