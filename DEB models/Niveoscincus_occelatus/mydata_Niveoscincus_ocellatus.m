...
data.ab = 92;      units.ab = 'd';    label.ab = 'age at birth';                bibkey.ab = 'MollCano2015';    
  temp.ab = T_C + 19.5;  % K, temperature 
  % observed age at birth is frequently larger than ab, because of diapauzes during incubation
data.ap = data.ab+1*365;     units.ap = 'd';    label.ap = 'age at puberty';              bibkey.ap = 'Anon2015';
  temp.ap = T_C + 17.7;  % K, temperature 
...
data.am = 13*365;     units.am = 'd';    label.am = 'life span';                   bibkey.am = 'Wiki';   
  temp.am = T_C + 17.7;  % K, temperature 
...
data.Lb  = 2.962;   units.Lb  = 'cm';   label.Lb  = 'snout to vent length at birth';    bibkey.Lb  = 'Anon2015';
data.Lp  = 5.0;   units.Lp  = 'cm';   label.Lp  = 'snout to vent length at puberty';  bibkey.Lp  = {'Anon2015';'Wiki'};
data.Li  = 7.3;   units.Li  = 'cm';   label.Li  = 'ultimate snout to vent length';    bibkey.Li  = 'Wiki';
data.Wdb = 0.55*0.3; units.Wdb = 'g';    label.Wdb = 'dry weight at birth';              bibkey.Wdb = 'Anon2015';
data.Wdp = 2.4*0.3;   units.Wdp = 'g';    label.Wdp = 'dry weight at puberty';            bibkey.Wdp = 'Anon2015';
data.Wdi = 7.1*0.3;   units.Wdi = 'g';    label.Wdi = 'ultimate dry weight';              bibkey.Wdi = 'Wiki';
data.Ri  = 5/365;    units.Ri  = '#/d';  label.Ri  = 'maximum reprod rate';              bibkey.Ri  = 'Wiki';   
  % for an individual of ultimate length Li 
  temp.Ri = T_C +  17.7;  % K, temperature 
...
units.LW = {'cm', 'g'};     label.LW = {'time since birth', 'wet weight'};  bibkey.LW = 'Anon2015';
